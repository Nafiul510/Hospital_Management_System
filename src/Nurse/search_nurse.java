...
public class search_nurse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bradcum_label.setText("laboratorist Panel >> Search lab");
        Search_nurse.add(bradcum_label);
        bradcum_label.setBounds(20, 0, 568, 70);
        ...
        bg_search.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Nurse/bg_nurse.jpg"))); // NOI18N
    ...
    private void search_txtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_search_txtKeyReleased
        conn = (Connection) MySqlConnect.ConnectDB();
        try{
            String sql = "SELECT * FROM nurse WHERE Name = ? or ID = ?";
            pst = conn.prepareStatement(sql);
