 ...
 * @author Nafiul Alam
 */
public class Update_lab extends javax.swing.JFrame {
    private Connection conn;
    private PreparedStatement pst;
    private ResultSet rs = null;

    /**
     * Creates new form Update_lab
     */
    public Update_lab() {
        initComponents();
         fetch_table();
...
try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_lab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_lab().setVisible(true);
            }
        });
    }
